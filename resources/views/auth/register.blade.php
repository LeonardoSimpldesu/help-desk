<x-layout.guest heading="Crie sua conta" subheading="Preencha os dados abaixo para criar sua conta">
    <form method="POST" action="{{ route('register') }}" class="space-y-4" novalidate>
        ...
        <x-forms.input label="Telefone" name="phone" type="tel" placeholder="(00) 00000-0000" hint="Fixo ou celular, com DDD"
            inputmode="numeric" autocomplete="tel-national" x-data x-mask:dynamic="{{ \App\Rules\BrazilianPhone::MASK }}" />
